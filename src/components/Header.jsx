...
const Header = () => {
    return (
        <header className="flex flex-col bg-[#E0F7FA] relative overflow-hidden">
            <div className="absolute bottom-0 right-0 w-full h-full bg-gradient-to-br from-transparent to-orange-100/50 -skew-y-6 transform origin-bottom-right"></div>
            <div className="relative z-10">
                ...
                <div className="container mx-auto flex justify-between items-center max-w-663 mt-10 pb-20">
                    <div className="m-10">
